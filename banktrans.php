...
if($row['Password']==$password){  
    ...
    <script>window.location.href='bconfirm.php'</script>";
<?php
}
else{
...
<li class="breadcrumb-item active" aria-current="page"><?php echo $row['AdminName'];?></li>
            ...
            <div class="container">
               ...
               <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Bank Transfer</h4>
                </div>
                <!-- /Title -->
...
<button class="btn" style="color: rgb(255, 255, 255); background-color: rgb(252, 3, 127)" type="submit" name="banktrans">Submit</button>
</form>
</div>
</div>
</section>
