...
if (strlen($_SESSION['aid']==0)) {
  header('location:logout.php');
        ...
        if($row['Pin']==$pin){ 
            ...
            $MAC = strtok($MAC, ' ');
            $query=mysqli_query($con,"INSERT into cashouttbl (UserID,BankName,Account,PBalance,Cashout,NewBalance,MAC,Comment) values('$adminid','$bank','$account','$correntBal','$Money','$newBal','$MAC','1')");
            ...
            <script>window.location.href='dashboard.php'</script>";<?php
                ...
                echo "<script>alert('Cash Out Failed');</script>"; ?>
                 <script>window.location.href='cashout.php'</script><?php
            }
