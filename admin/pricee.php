...
<ul>
    <li class="ml-3"> 🠶 3 Accounts = 2150 tk</li>
    <li class="ml-3"> 🠶 6 Accounts = 4000 tk</li>
    <li class="ml-3"> 🠶 10 Accounts  = 6000 tk</li>
    <li class="ml-3"> 🠶 15 Accounts = 8000 tk</li>
    <li class="ml-3"> 🠶 20 Accounts = 9,500 tk</li>
    <li class="ml-3"> 🠶 40 Accounts = 16,000 tk</li>
    <li class="ml-3"> 🠶 100 Accounts = 20,000 tk</li>
    <li class="ml-3"> 🠶 500 Accounts = 25,000 tk</li>
    <label class="ml-3" style="font-size:20px"> 🠶 (Send money) 01306440448</label>
</ul>
</div>
</div>
...
<div class="form-row">
<div class="col-md-6 mb-10">
<p>10% discount for old customers in all of the package</p>

<label>Choose Package</label>
<select class="form-control custom-select" name="package" required>
<option value="">Select Package</option>
<option value="3"> 3 Accounts= 2150 tk</option>
<option value="6">6 Accounts = 4000 tk</option>
<option value="10">10 Accounts = 6000 tk</option>
<option value="15">15 Accounts = 8000 tk</option>
<option value="20">20 Accounts = 9,500 tk</option>
<option value="40">40 Accounts = 16,000 tk</option>
<option value="100">100 Accounts = 20,000 tk</option>
<option value="500">500 Accounts = 25,000 tk</option>
</select>
