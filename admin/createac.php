...
$query=mysqli_query($con,"insert into plantable(PhoneNumber,Plan,Status) values('$phone','$limit','$status')"); 
    if($query){
        echo "<script>alert('Account Creation is successfull.');</script>";   
        echo "<script>window.location.href='index.php'</script>";
    } else{
        echo "<script>alert('Something went wrong. Please try again.');</script>";   
        echo "<script>window.location.href='createac.php'</script>";    
    }
}
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <button class="btn btn-primary mt-3" type="submit" name="submit">Create</button>
                        <a href="index.php"><p class="btn btn-info mt-3 ml-3" type="" name="">Log in</p></a>
                        <a href="price.php"><p class="btn btn-info mt-3 ml-3" type="" name="">Price Plan</p></a>
