...
// Code for deletion       
    if(isset($_GET['add'])){  
        ...
        $query1=mysqli_query($con,"select * from deposit where Account='$cmpid' AND Reference='$ref' ");
        ...
        $query4=mysqli_query($con,"update deposit set Status='1' where Account='$cmpid' AND Reference='$ref' "); 
                                    ...
                                    <div style="overflow-x:scroll;">
                                        <table style="min-width: 600px;"  id="datable_1" class=" table table-hover w-100 display pb-30">
                                            ...
                                            <tbody>
                                                ...
                                                $ref=$_SESSION['admin'];
                                                $query = mysqli_query($con,"SELECT * FROM deposit where Reference='$ref'");
                                                $cnt=1;
                                            ...
                                            <?php }else { ?> <button type="button" class="btn btn-success">Success</button> <?php }
                                                ...
                                                <?php if ($row['Status']!=1){ ?>
                                                <a href="add-funds.php?add=<?php echo base64_encode($row['Account'].$rno);?>" data-toggle="tooltip" data-original-title="Add" onclick="return confirm('Do you really want to add?');"> <i class="icon-plus txt-danger"></i> </a> <?php } ?>
                                                </td>
                                                </tr>
                                                <?php 
                                                $cnt++;
