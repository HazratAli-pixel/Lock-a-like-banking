...
$query=mysqli_query($con,"update tbladminmain set Name='$adminname',PhoneNumber='$mobileno',Email='$emailid' where id='$adminid'"); 
if($query){
...
//Getting admin name
$adminid=$_SESSION['admin'];
$query=mysqli_query($con,"select * from tbladminmain where PhoneNumber='$adminid'");
...
<input type="text" class="form-control" id="validationCustom03" value="<?php echo $row['PhoneNumber'];?>" name="username" readonly>
</div>
</div>
...
<input type="text" class="form-control" id="validationCustom03" value="<?php echo $row['Photo'];?>" name="mobilenumber" required>
