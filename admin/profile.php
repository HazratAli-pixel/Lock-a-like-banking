...
<img src="dist/img/<?php echo $row['Photo'];?>" style="width: 250px;" alt="user" class="">
</div>
</div>
...
<input type="text" class="form-control" id="validationCustom03" value="<?php echo $row['PhoneNumber'];?>" name="mobilenumber" required>
