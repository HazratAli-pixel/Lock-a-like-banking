...
if (strlen($_SESSION['admin']==0)) {
  header('location:logout.php');
    ...
    {   $baccount=$_POST['B_account']; 
        $baccount = preg_replace('/[^0-9]/', '', $baccount);  
        $baccount = ltrim($baccount, "0"); 
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        if($listedcat>=$msg){ ?>
                        <p style="font-size:12px;">Your account creation limite is <?php echo $plan; ?>. You all ready created  <?php echo $listedcat; ?> Accounts. Please Upgrade your account to avoid any interruption. want to upgrade? <a href="pricee.php"> click here</a></p>
                        <?php  }} 
                        if ($listedcat>=$plan){
                        ?>
                        <button disabled class="btn btn-primary mt-3 mb-3" type="submit" name="submit">Submit</button>
                        
                        <p style="font-size:12px;">You can not create new account. Your account creation limite is <?php echo $plan; ?>. So Please Upgrade your Plan, want to upgrade? <a href="pricee.php"> click here</a> </p>
