                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="form-row">
                            <div class="col-md-6 col-12 mb-12">
                                ...
                                <input type="text" class="form-control" id="validationCustom03" value="<?php echo $row['AcBal'];?>"  placeholder="Enter Balance (tk)" name="balance" disabled required>
                        ...
                        <div class="form-row">
                         ...
                         <button class="btn btn-primary mt-3 mb-3" type="submit" name="submit" disabled>Update</button>
                        <?php 
                        $msg=$plan*.80;
                        if($listedcat>$msg){ ?>
                        <p style="font-size:12px;"> You can not create new account only update is available. Your account creation limite is <?php echo $plan; ?>. You all ready created  <?php echo $listedcat; ?> Accounts. Please Upgrade your account to avoid any interruption. Thank you</p>
