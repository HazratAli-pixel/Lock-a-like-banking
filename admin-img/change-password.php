...
$query=mysqli_query($con,"select ID from tbladminmain where PhoneNumber='$adminid' and   Password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tbladminmain set Password='$newpassword' where PhoneNumber='$adminid'");
