...
$query2 = mysqli_query($con,"insert into plantable(PhoneNumber,Plan) values('$phone','$ac_limit')"); 
    if($query){
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 col-12 mb-12">
                                ...
                                <input type="text" class="form-control" id="validationCustom03" placeholder="account creation limit" name="ac_limit" required>
                                <div class="invalid-feedback">Please provide a valid ac number</div>
                            </div>
