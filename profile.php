...
<li class="breadcrumb-item active" aria-current="page"><?php echo $row['AdminName'];?></li>
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Update Your Profile</h4>
                </div>
                <!-- /Title -->
...
<div class="form-row">
<div class="col-md-6 mb-10" style=" background-size: 200px 200px; background-repeat: no-repeat; background-image:url(dist/img/<?php echo $row['photo'];?>);">
<div style=" margin-left: 70px; margin-top: 100px;"><img src="dist/img/aproved.png" style="width: 150px;" alt="user" class=""></div>
...
<div class="form-row">
<div class="col-md-6 mb-10">
<label style="color: rgb(252, 3, 127)" for="validationCustom03"><strong> Name</strong></label>
...
<div class="form-row">
<div class="col-md-6 mb-10">
<label style="color: rgb(252, 3, 127)" for="validationCustom03"><strong> Email id</strong></label>
...
<div class="form-row">
<div class="col-md-6 mb-10">
<label style="color: rgb(252, 3, 127)" for="validationCustom03"><strong> Mobile Number</strong></label>
