...
$query=mysqli_query($con,"select ID from tbladmin where MobileNumber='$adminid' and   Password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tbladmin set Password='$newpassword' where MobileNumber='$adminid'");
